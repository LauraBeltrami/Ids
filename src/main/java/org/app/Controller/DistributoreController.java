...
import org.app.Service.DistributoreService;
...
public class DistributoreController {
    ...
    public void rimuoviBundle(@PathVariable Long distributoreId,
                              @PathVariable Long bundleId) {
        distributoreService.rimuoviBundle(distributoreId, bundleId);
    }
}