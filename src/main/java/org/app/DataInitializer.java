...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Venditore v1 = new Venditore(
                null,
                "Salumi Rossi",
                "Via Roma 10, Milano", // <--- 3° Posto: INDIRIZZO
                "salumi@mail.com",     // <--- 4° Posto: EMAIL (Deve essere valida!)
        ...
        Distributore d1 = new Distributore(
                ...
                "Corso Italia 50, Torino", // <--- 3° Posto: INDIRIZZO
                "vini@mail.com",           // <--- 4° Posto: EMAIL
                passwordEncoder.encode("pass")
        );
