...
import org.app.DTO.BundleDTO;
import org.app.DTO.BundleMapper;
import org.app.Exceptions.BusinessException;
import org.app.Exceptions.NotFoundException;
import org.app.Model.*;
import org.app.Repository.BundleItemRepository;
import org.app.Repository.BundleRepository;
import org.app.Repository.DistributoreRepository;
...
public class DistributoreService {
    ...
    public void rimuoviBundle(Long distributoreId, Long bundleId) {
        Bundle bundle = bundleRepo.findGraphById(bundleId)
                .orElseThrow(() -> new NotFoundException("Bundle non trovato: " + bundleId));
        if (!bundle.getDistributore().getId().equals(distributoreId)) {
            throw new BusinessException("Il distributore non è proprietario di questo bundle.");
        }
